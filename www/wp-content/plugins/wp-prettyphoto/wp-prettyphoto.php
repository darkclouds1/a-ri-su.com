  ...
  */
  public function __construct() {
    ...
    if (!is_admin()) {
      ...
      wp_register_script('prettyphoto', $wpurl.'js/jquery.prettyPhoto.js', array('jquery'), '2.5.5');
      wp_enqueue_script('prettyphoto');
      // prettyPhoto CSS
      wp_register_style('prettyphoto', $wpurl.'css/prettyPhoto.css', false, '2.5.5', 'screen');
