...
if ( version_compare( '4.3', phpversion(), '>' ) )
	wp_die( sprintf( /*WP_I18N_OLD_PHP*/'Dein Server läuft mit der PHP-Version %s, WordPress benötigt jedoch mindestens die Version 4.3.'/*/WP_I18N_OLD_PHP*/, phpversion() ) );
