...
class wpdb {
	...
	function __construct($dbuser, $dbpassword, $dbname, $dbhost) {
		...
		if (!$this->dbh) {
			$this->bail(sprintf(/*WP_I18N_DB_CONN_ERROR*/'<h1>Fehler beim Aufbau der Datenbank-Verbindung</h1>
...
<p>Wenn du nicht sicher bist woran es liegt, kontaktiere am besten deinen Hoster. Wenn du weitergehende Hilfe brauchst, kannst du dich jederzeit an das <a href=\'http://forum.wordpress-deutschland.org/\'>Support-Forum</a> (<a href=\'http://wordpress.org/support/\'>en</a>) wenden.</p>'/*/WP_I18N_DB_CONN_ERROR*/, $dbhost), 'db_connect_fail');
			return;
		}
	...
	function select($db) {
		if (!@mysql_select_db($db, $this->dbh)) {
			$this->ready = false;
			$this->bail(sprintf(/*WP_I18N_DB_SELECT_DB*/'<h1>Die Datenbank kann nicht gewählt werden</h1>
<p>Es konnte zwar eine Verbindung zum Datenbankserver hergestellt werden (das bedeutet, dass dein Benutzername und das Passwort stimmen), aber die entsprechende Datenbank <code>%1$s</code> kann nicht gewählt werden.</p>
<ul>
